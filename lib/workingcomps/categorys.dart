import 'package:coffee/pages/in-app%20pages/categoryland.dart';
    ...
    onTouch: (BuildContext context) {
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) => SafeArea(
          child: SafeArea(
            child: Scaffold(
              body: Categoryland(category: Category(link:'https://unicode-flutter-lp.onrender.com/get_products_by_category?category=HOT%20BEVERAGES' ,
              image: 'https://athome.starbucks.com/sites/default/files/2021-06/1_CAH_CaffeMocha_Hdr_2880x16602.jpg', 
                     title: 'HOT BEVERAGES',  
                     onTouch:(context) {},)),
            ),
     ...
     onTouch: (BuildContext context) {
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) => SafeArea(
          child: SafeArea(
            child: Scaffold(
              body: Categoryland(category: Category(link: 'https://unicode-flutter-lp.onrender.com/get_products_by_category?category=ICED%20BEVERAGES',
    image: 'https://athome.starbucks.com/sites/default/files/2024-05/OTHC-P00122733_COLD_ChocolateHazelnut_2880x1660_0.png', 
    title: 'ICED BEVERAGES',  
                     onTouch:(context) {},)),
            ),
     ...
     onTouch: (BuildContext context) {
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) => SafeArea(
          child: SafeArea(
            child: Scaffold(
              body: Categoryland(category: Category(link: 'https://unicode-flutter-lp.onrender.com/get_products_by_category?category=ADD-INS',
    image: 'https://athome.starbucks.com/sites/default/files/2022-05/1_CAH_IcedCoffeeSphere_Hdr_2880x1660_0.jpg', 
    title: 'ADD-INS',  
                     onTouch:(context) {},)),
            ),
     ...
     onTouch: (BuildContext context) {
      Navigator.push(
        ...
        MaterialPageRoute(builder: (context) => SafeArea(
          child: SafeArea(
            child: Scaffold(
              body: Categoryland(category: Category(link: 'https://unicode-flutter-lp.onrender.com/get_products_by_category?category=FOOD',
    image: 'https://athome.starbucks.com/sites/default/files/2021-08/1_CAH_OvernightGrainBowl_Hdr_2880x1660_0.jpg', 
    title: 'FOOD',  
                     onTouch:(context) {},)),
            ),
